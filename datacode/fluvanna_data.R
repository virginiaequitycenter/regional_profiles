## ...........................
## Script name: fluvanna_data.R
##
## Authors: Michele Claibourn, Jordan House
...
write_csv(demographic_table, "data/fluvanna/demographic_table.csv")
...
write_csv(sex_age, "data/fluvanna/sex_age.csv")
...
final_ed_table %>%
  ...
  write_csv(., path = "data/fluvanna/education_distrbution.csv")
...
save(origin, citizenship, nativity, file = "data/fluvanna/origins.Rda")
...
write_csv(tract_ahdi, "data/fluvanna/tract_ahdi.csv")

# not sure we need this, but just in case
write_csv(tract_schl, "data/fluvanna/tract_enroll.csv")
...
write_csv(geo_ed, "data/fluvanna/tract_education.csv")
...
write_csv(housing_costs, "data/fluvanna/housing_costs.csv")
...
write_csv(alice_county, "data/fluvanna/alice_hhs.csv")
...
write_csv(alice_hhinc_thresh, "data/fluvanna/alice_thresh.csv")
...
write_csv(tract_med_inc, "data/fluvanna/med_inc_tract.csv")
