...
write_csv(demographic_table, "data/louisa/demographic_table.csv")
...
write_csv(sex_age, "data/louisa/sex_age.csv")
...
final_ed_table %>%
  ...
  write_csv(., path = "data/louisa/education_distrbution.csv")
...
save(origin, citizenship, nativity, file = "data/louisa/origins.Rda")
...
write_csv(tract_ahdi, "data/louisa/tract_ahdi.csv")

# not sure we need this, but just in case
write_csv(tract_schl, "data/louisa/tract_enroll.csv")
...
write_csv(geo_ed, "data/louisa/tract_education.csv")
...
write_csv(housing_costs, "data/louisa/housing_costs.csv")
...
write_csv(alice_county, "data/louisa/alice_hhs.csv")
...
write_csv(alice_hhinc_thresh, "data/louisa/alice_thresh.csv")
...
write_csv(tract_med_inc, "data/louisa/med_inc_tract.csv")
