## ...........................
## Script name: charlottesville_data.R
##
...
write_csv(demographic_table, "data/charlottesville/demographic_table.csv")
...
write_csv(sex_age, "data/charlottesville/sex_age.csv")
...
final_ed_table %>%
  ...
  write_csv(., path = "data/charlottesville/education_distrbution.csv")
...
save(origin, citizenship, nativity, file = "data/charlottesville/origins.Rda")
...
write_csv(tract_ahdi, "data/charlottesville/tract_ahdi.csv")

# not sure we need this, but just in case
write_csv(tract_schl, "data/charlottesville/tract_enroll.csv")
...
write_csv(geo_ed, "data/charlottesville/tract_education.csv")
...
write_csv(housing_costs, "data/charlottesville/housing_costs.csv")
...
write_csv(alice_county, "data/charlottesville/alice_hhs.csv")
...
write_csv(alice_hhinc_thresh, "data/charlottesville/alice_thresh.csv")
...
write_csv(tract_med_inc, "data/charlottesville/med_inc_tract.csv")
