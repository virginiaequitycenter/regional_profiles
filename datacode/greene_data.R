...
write_csv(demographic_table, "data/greene/demographic_table.csv")
...
write_csv(sex_age, "data/greene/sex_age.csv")
...
final_ed_table %>%
  ...
  write_csv(., path = "data/greene/education_distrbution.csv")
...
save(origin, citizenship, nativity, file = "data/greene/origins.Rda")
...
write_csv(tract_ahdi, "data/greene/tract_ahdi.csv")

# not sure we need this, but just in case
write_csv(tract_schl, "data/greene/tract_enroll.csv")
...
write_csv(geo_ed, "data/greene/tract_education.csv")
...
write_csv(housing_costs, "data/greene/housing_costs.csv")
...
write_csv(alice_county, "data/greene/alice_hhs.csv")
...
write_csv(alice_hhinc_thresh, "data/greene/alice_thresh.csv")
...
write_csv(tract_med_inc, "data/greene/med_inc_tract.csv")
