...
write_csv(demographic_table, "data/nelson/demographic_table.csv")
...
write_csv(sex_age, "data/nelson/sex_age.csv")
...
final_ed_table %>%
  ...
  write_csv(., path = "data/nelson/education_distrbution.csv")
...
save(origin, citizenship, nativity, file = "data/nelson/origins.Rda")
...
write_csv(tract_ahdi, "data/nelson/tract_ahdi.csv")

# not sure we need this, but just in case
write_csv(tract_schl, "data/nelson/tract_enroll.csv")
...
write_csv(geo_ed, "data/nelson/tract_education.csv")
...
write_csv(housing_costs, "data/nelson/housing_costs.csv")
...
write_csv(alice_county, "data/nelson/alice_hhs.csv")
...
write_csv(alice_hhinc_thresh, "data/nelson/alice_thresh.csv")
...
write_csv(tract_med_inc, "data/nelson/med_inc_tract.csv")
